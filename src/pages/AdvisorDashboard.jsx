                          ...
                          <tr key={client.codigo_cliente} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                {/*  BOTÓN NUEVO: Enviar ID al Simulador */}
                                <Tooltip title="Crear nueva simulación" arrow placement="top">
                                  <button
                                      onClick={() => navigate('/simulador', { state: { clientePreseleccionado: client.codigo_cliente } })}
                                ...
                                <Tooltip title="Ver simulaciones previas" arrow placement="top">
                                  <button
